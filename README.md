...
Dimensionality reduction and visualization techniques such as principal component analysis (PCA).
	...
	- #### Introduction to Information Management (5 ECTS) [Python]
		- Application systems and information systems as well as business processes and their support by ERP systems are covered. IN addition, the lectures address basic knowledge related to data management. The concept of data modeling is captured by an introduction to the Entity-Relationship-Model and supplemented by the practical application of databases. Subsequently, an introduction programming is given, utilizing the programming language Python.
